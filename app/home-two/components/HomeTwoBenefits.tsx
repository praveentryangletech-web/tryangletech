              ...
              <div className="w-layout-grid rt-benefits-content-one">
                ...
                <div
                  ...
                  <div className="rt-benefits-item-text">
                    ...
                    <p>
                      Keep projects structured with task lists, deadlines, and
                      priorities, so nothing slips through the cracks.
                    </p>
                  </div>
                </div>
                <div
                  ...
                  <div className="rt-benefits-item-text">
                    ...
                    <p>
                      Monitor task completion, visualize timelines, and track
                      milestones to ensure projects stay on schedule.
                    </p>
                  </div>
                </div>
              </div>
              <div
                ...
                <div className="rt-benefits-item rt-bottom">
                  ...
                  <div className="rt-benefits-item-text">
                    ...
                    <p>
                      Smart tracking helps identify bottlenecks early, ensuring
                      projects are delivered on time without last-minute stress.
                    </p>
                  </div>
                </div>
                <div className="rt-benefits-item rt-bottom">
                  ...
                  <div className="rt-benefits-item-text">
                    ...
                    <p>
                      Enable seamless communication across teams by sharing
                      tasks, updates, and progress in real-time. With everyone
                      on the same page,
                    </p>
                  </div>
                </div>
