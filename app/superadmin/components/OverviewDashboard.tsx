  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: '1.25rem 0' }}>
      ...
      <div
        ...
        <div className="admin-white-card" style={{ padding: '1.25rem 1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <span style={{ fontSize: '0.825rem', color: '#64748B', fontWeight: 700 }}>Quote Requests</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginTop: '0.4rem', fontSize: '0.775rem', color: '#6366F1', fontWeight: 700 }}>
            <span>⚡ Est. Pipeline: $45,000+</span>
          </div>
        </div>
