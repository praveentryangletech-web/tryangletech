        ...
        <div className="w-layout-blockcontainer rt-container w-container">
          <div className="rt-hero-11-heading rt-desktop-text-center rt-heading-bottom-gap">
            ...
            <h1 className="rt-gap-off">
              Boosting productivity through smarter task systems
            </h1>
            <div
              data-w-id="97cdad1e-28a3-a3a7-87a6-42ffbd705c52"
          ...
          <div
            ...
            <div className="tabs-menu w-tab-menu" role="tablist">
              <Link
                ...
                href="/blog-two#w-tabs-0-data-w-pane-0"
                role="tab"
                      ...
                      <Link
                        ...
                        <div className="w-layout-vflex rt-blog-card-v1-top-part">
                          ...
                          <div className="rt-blog-v1-line rt-v2">
                            <div
                              data-w-id="de953805-1870-6ed6-ce75-e38caa4ac323"
                              className="rt-blog-v3-line-overlay"></div>
                          </div>
                    ...
                    <div role="listitem" className="w-dyn-item">
                      <Link
                        ...
                        <div className="w-layout-vflex rt-blog-card-v1-top-part">
                          ...
                          <div className="rt-text-style-h6">
                            Simplify projects through intelligent task
                            management
                          </div>
                        </div>
                      </Link>
                    ...
                    <div role="listitem" className="w-dyn-item">
                      <Link
                        ...
                        <div className="w-layout-vflex rt-blog-card-v1-top-part">
                          ...
                          <div className="rt-text-style-h6">
                            Accelerate project delivery with organized workflow
                            planning
                          </div>
                        </div>
                      </Link>
                    ...
                    <div role="listitem" className="w-dyn-item">
                      <Link
                        ...
                        <div className="w-layout-vflex rt-blog-card-v1-top-part">
                          ...
                          <div className="rt-text-style-h6">
                            How to integrate taskopia with your favorite
                            productivity tools
                          </div>
                        </div>
                      </Link>
                    ...
                    <div role="listitem" className="w-dyn-item">
                      <Link
                        ...
                        <div className="w-layout-vflex rt-blog-card-v1-top-part">
                          ...
                          <div className="rt-blog-v2-text-line"></div>
                          <div className="rt-text-style-h6">
                            Empowering teams through structured project planning
                          </div>
                        </div>
