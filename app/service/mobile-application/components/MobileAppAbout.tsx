            ...
            <div className="rt-about-v3-right">
              ...
              >
                <p className="rt-gap-off rt-color-pale-periwinkle">
                  From conceptualization and design to coding, testing, and App Store launch, we provide end-to-end mobile development services that bring your vision to life.
                </p>
              </div>
              <div
              ...
              >
                <div className="w-layout-vflex rt-analytics-v2-box">
                  ...
                  <div className="w-layout-vflex rt-analytics-v2-text-wrap">
                    ...
                    <p className="rt-gap-off rt-color-pale-periwinkle">
                      Build natively for iOS and Android or opt for cross-platform solutions.
                    </p>
                  </div>
                </div>
                <div className="w-layout-vflex rt-analytics-v2-box">
                  ...
                  <div className="w-layout-vflex rt-analytics-v2-text-wrap">
                    ...
                    <p className="rt-gap-off rt-color-pale-periwinkle">
                      Continuous delivery and transparent communication at every project milestone.
                    </p>
                  </div>
                </div>
              </div>
