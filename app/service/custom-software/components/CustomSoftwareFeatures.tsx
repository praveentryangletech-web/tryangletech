        ...
        <div className="w-layout-blockcontainer rt-container-main w-container">
          <div className="rt-tools-iconheading rt-speciality-heading rt-heading-bottom-gap">
            <div className="rt-sub-gap">
              <div className="rt-sub-text rt-sub-gredient">what we build</div>
            </div>
            <div
              ...
              <h2 className="rt-gap-off rt-desktop-text-center">
                Powerful, scalable, and secure custom software engineered for your exact needs
              </h2>
          ...
          <div className="rt-speciality-wrapper">
            ...
            <div
              ...
              <div className="rt-speciality-item-top">
                ...
                <p className="rt-gap-off">
                  Connect your new software with existing tools — ERPs, CRMs, payment gateways, third-party APIs, and more — through robust, reliable integration layers.
                </p>
              </div>
              <div className="rt-speciality-item-bottom rt-2">
                ...
                <div data-w-id="60af2a98-b52b-8db3-3b1b-8acaee57774c">
                  <Image
                    ...
                    loading="lazy"
                    alt="custom-integrations-2"
                    width={800} height={800} style={{ width: "100%", height: "auto" }} />
                </div>
              </div>
            </div>

            {/* Card 3: Agile Development */}
            <div
