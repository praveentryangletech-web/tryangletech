                      ...
                      <div className="w-layout-vflex" style={{ flex: 1, paddingTop: '12px' }}>
                        ...
                        <div className="w-layout-hflex rt-pages-menu-wrap" style={{ paddingTop: 0 }}>
                          ...
                          <div className="w-layout-vflex rt-pages-menu-list-wrap">
                            {/* Web Development */}
                            <Link href="/service/web-development" prefetch={false} data-w-id="b07e93b6-139e-136c-8189-3251b36d925d" className={`rt-pages-menu-link-wrap w-inline-block ${pathname === '/service/web-development' ? 'is-active' : ''}`} tabIndex={0}>
                            ...
                            {/* Custom Software */}
                            <Link href="/service/custom-software" prefetch={false} data-w-id="b07e93b6-139e-136c-8189-3251b36d9268" className={`rt-pages-menu-link-wrap w-inline-block ${pathname === '/service/custom-software' ? 'is-active' : ''}`} tabIndex={0}>
                              <div className="w-layout-hflex rt-pages-menu-content">
                                <div>
                            ...
                            {/* Mobile Application */}
                            <Link href="/service/mobile-application" prefetch={false} data-w-id="b07e93b6-139e-136c-8189-3251b36d9273" className={`rt-pages-menu-link-wrap w-inline-block ${pathname === '/service/mobile-application' ? 'is-active' : ''}`} tabIndex={0}>
                              <div className="w-layout-hflex rt-pages-menu-content">
                                <div>
                          ...
                          <div className="w-layout-vflex rt-pages-menu-list-wrap">
                            {/* Digital Marketing */}
                            <Link href="/service/digital-marketing" prefetch={false} data-w-id="b07e93b6-139e-136c-8189-3251b36d928a" className={`rt-pages-menu-link-wrap w-inline-block ${pathname === '/service/digital-marketing' ? 'is-active' : ''}`} tabIndex={0}>
                              <div className="w-layout-hflex rt-pages-menu-content">
                                <div>
                            ...
                            {/* Graphics Designing */}
                            <Link href="/service/graphics-designing" prefetch={false} data-w-id="b07e93b6-139e-136c-8189-3251b36d9295" className={`rt-pages-menu-link-wrap w-inline-block ${pathname === '/service/graphics-designing' ? 'is-active' : ''}`} tabIndex={0}>
                              <div className="w-layout-hflex rt-pages-menu-content">
                                <div>
                      ...
                      */}
                      ...
                      <div data-delay="300" data-hover="true" className="rt-navbar-dropdown w-dropdown" style={{ maxWidth: "1750px" }}>
                        ...
                        <nav className="rt-navbar-menu-dropdown rt-overflow-hidden w-dropdown-list" id="w-dropdown-list-5" aria-labelledby="w-dropdown-toggle-5" style={{ width: "max-content", minWidth: "220px" }}>
                          <Link href="/service/web-development" prefetch={false} className="rt-nav-menu-link rt-first w-dropdown-link" style={pathname === '/service/web-development' ? { color: '#1833fe', fontWeight: 700 } : undefined} tabIndex={0}>Website Development</Link>
                          <Link href="/service/custom-software" prefetch={false} className="rt-nav-menu-link w-dropdown-link" style={pathname === '/service/custom-software' ? { color: '#1833fe', fontWeight: 700 } : undefined} tabIndex={0}>Custom Software</Link>
                          <Link href="/service/mobile-application" prefetch={false} className="rt-nav-menu-link w-dropdown-link" style={pathname === '/service/mobile-application' ? { color: '#1833fe', fontWeight: 700 } : undefined} tabIndex={0}>Mobile Application</Link>
                          <Link href="/service/digital-marketing" prefetch={false} className="rt-nav-menu-link w-dropdown-link" style={pathname === '/service/digital-marketing' ? { color: '#1833fe', fontWeight: 700 } : undefined} tabIndex={0}>Digital Marketing</Link>
                          <Link href="/service/graphics-designing" prefetch={false} className="rt-nav-menu-link rt-last w-dropdown-link" style={pathname === '/service/graphics-designing' ? { color: '#1833fe', fontWeight: 700 } : undefined} tabIndex={0}>Graphics Designing</Link>
                        </nav>
                      </div>
