          ...
          <div className="w-layout-blockcontainer rt-container-main w-container">
            ...
            <div data-w-id="7755f54e-a063-7fd1-4011-b0bcae52ff74" className="rt-choose-v3-wrap">
              {[
                ...
                { icon: `${A}/6916ef876682eed2b2fd5911_Vector (34).svg`, title: 'Full-Service IT Company', desc: 'Website development, mobile apps, digital marketing, SEO, graphics, and custom software, everything your business needs under one roof.' },
              ].map(({ icon, title, desc }) => (
