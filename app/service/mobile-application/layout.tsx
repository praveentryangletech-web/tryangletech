            ...
            "@graph": [
              {
                ...
                "serviceType": "iOS, Android, and Cross-Platform Mobile Apps",
                "description": "Custom mobile application engineering with React Native, Flutter, Swift, and Kotlin for iOS and Android devices.",
                "provider": {
                  "@type": "Organization",
                  "name": "TryangleTech",
                ...
                "hasOfferCatalog": {
                  ...
                  "itemListElement": [
                    ...
                    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Flutter Mobile Apps" } },
                    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Native iOS & Android Engineering" } }
                  ]
                }
              },
              {
