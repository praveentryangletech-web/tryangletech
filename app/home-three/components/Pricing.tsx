    ...
    <>
      <section className="rt-pricing-v1">
        <div className="w-layout-blockcontainer rt-container-main w-container">
            ...
            <div
              ...
              <div className="rt-pricing-toggle">
                ...
                <div
                  ...
                  <div
                    className="rt-pricing-v1-toggle"
                    style={{
                      transform:
          ...
          <div
            className="w-layout-grid rt-pricing-v1-card-main rt-month"
            style={{ display: "grid" }}>
            <div
              ...
              <div className="w-layout-vflex rt-pricing-v1-heading-mainn">
                <div className="w-layout-vflex rt-pricing-v1-card-heading">
                  ...
                  <p className="rt-gap-off">
                    Your journey with our starter plan—essential tools at great
                    value
                  </p>
                </div>
                <div className="w-layout-vflex rt-pricing-v3-card-plan-wrap">
                  <div className="w-layout-hflex rt-pricing-v3-discount-main">
                    <div className="w-layout-hflex rt-pricing-v3-amount-wrap">
                      ...
                      <div className="rt-text-color-moonlit-steel">/ Month</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-layout-vflex rt-pricing-v1-card rt-border-radius-medium rt-background-white">
                <div className="w-layout-vflex rt-pricing-v1-heading-mainn">
                  <div className="w-layout-vflex rt-pricing-v1-card-heading">
                    ...
                    <p className="rt-gap-off">
                      Choose a plan that fits your needs and unlock seamless AI
                      automation today
                    </p>
                  </div>
                  <div className="w-layout-vflex rt-pricing-v3-card-plan-wrap">
          ...
          <div
            className="w-layout-grid rt-pricing-v1-card-main rt-year"
            style={{ display: "none" }}>
            <div
