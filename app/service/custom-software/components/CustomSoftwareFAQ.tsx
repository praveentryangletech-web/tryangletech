...
import { CustomSoftwareFaqItem } from '@/backend/services/services/services.types';

interface CustomSoftwareFAQProps {
  faqs?: CustomSoftwareFaqItem[];
}

const DEFAULT_FAQS: CustomSoftwareFaqItem[] = [
  {
    id: 'faq-1',
...
export default function CustomSoftwareFAQ({ faqs = DEFAULT_FAQS }: CustomSoftwareFAQProps) {
