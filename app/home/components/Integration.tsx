              ...
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-1">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-1"  height={800} />
                </div>
              </div>
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-2">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-3"  height={800} />
                </div>
              </div>
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-3">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-2"  height={800} />
                </div>
              </div>
              ...
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-5">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-4"  height={800} />
                </div>
              </div>
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-6">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-5"  height={800} />
                </div>
              </div>
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-7">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-6"  height={800} />
                </div>
              </div>
              <div style={{ "opacity": "0" }} className="rt-integration-icon-wrap rt-8">
                <div>
                  <Image
                    ...
                    loading="lazy"
                    width={19}
                    alt="taskopia-integration-icon-7"  height={800} />
                </div>
              </div>
              <div
