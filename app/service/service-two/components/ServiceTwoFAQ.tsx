...
"
        ...
        <div className="rt-position-relative">
          ...
          <div
            data-w-id="0797f528-f306-de25-bf92-a6f5bc1a9d92"
            className="w-layout-hflex rt-section-line-wrap rt-margin-auto">
            <div className="rt-section-overlay"></div>
          </div>
        </div>
          ...
          <div className="w-layout-blockcontainer rt-container-extra-large w-container">
            <div className="rt-collaborate-card-main rt-position-relative rt-overflow-hidden">
              <div className="rt-footer-card-content rt-desktop-text-center">
                ...
                <div className="rt-heading-para-gap">
                  <h2
                    data-w-id="b9d08fca-feec-a53d-e33a-1ec9279fb1c2"
                    className="rt-text-color-white rt-gap-off">
                    Collaborate seamlessly, manage projects with ease
                  </h2>
                </div>
                <p
                  data-w-id="b9d08fca-feec-a53d-e33a-1ec9279fb1c4"
                  className="rt-text-color-white rt-gap-off rt-footer-card-para">
                  Simplify your workflow with a single platform that keeps
                  tasks, deadlines, and teams perfectly aligned.
                </p>
                <div
              ...
              <div
                data-w-id="b9d08fca-feec-a53d-e33a-1ec9279fb1c8"
                className="rt-collaborate-card-line-1 rt-tab-display-none">
                <div className="rt-collaborate-icon rt-1">
                  <div>
                    <Image
                      src="/service-2-assets/690c965e97785a12d9fab6b0_Nira (1).svg"
                      loading="lazy"
                      alt=""
                     width={800} height={800} style={{ width: "100%", height: "auto" }} />
                  </div>
                </div>
                <div className="rt-collaborate-icon rt-2">
                  <div>
                    <Image
                      src="/service-2-assets/690c965e97785a12d9fab6b0_Nira (1).svg"
                      loading="lazy"
                ...
                <div className="rt-collaborate-icon rt-3">
                  <div>
                    <Image
                      src="/service-2-assets/690c965e97785a12d9fab6b0_Nira (1).svg"
                      loading="lazy"
                ...
                <div className="rt-collaborate-icon rt-4">
                  <div>
                    <Image
                      src="/service-2-assets/690c965e97785a12d9fab6b0_Nira (1).svg"
                      loading="lazy"
              ...
              <div
                data-w-id="b9d08fca-feec-a53d-e33a-1ec9279fb1d5"
                className="rt-collaborate-card-line-2 rt-tab-display-none">
                <div className="rt-collaborate-icon rt-1">
                  <div>
                    <Image
                      src="/service-2-assets/690c965e97785a12d9fab6b0_Nira (1).svg"
              ...
              <div
                data-w-id="b9d08fca-feec-a53d-e33a-1ec9279fb1e2"
                className="rt-collaborate-card-line-3 rt-tab-display-none">
                <div className="rt-collaborate-icon rt-1">
                  <div>
                    <Image
                      src="/service-2-assets/690c965e97785a12d9fab6b0_Nira (1).svg"
