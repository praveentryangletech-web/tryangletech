...
interface MobileAppTypesTabProps {
...
export default function MobileAppTypesTab({ formData, setFormData, onOpenAssetPicker }: MobileAppTypesTabProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 800, color: 'var(--dark-indigo, #1a0b54)', margin: 0 }}>
            3. Mobile App Types We Build
          </h3>
          <p style={{ margin: '3px 0 0 0', fontSize: '0.8rem', color: '#64748B' }}>
            Configure the 5 mobile application categories (Native iOS/Android, Cross-Platform, E-Commerce, Enterprise, AI Automation) with mockup screenshots and performance badges.
          </p>
        </div>
        <span
          style={{
      ...
      {/* Sub Badge, Heading & Intro Description */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Unveiling the Variety in Mobile App Types We Build"
      ...
      <div>
        <label style={labelStyle}>Section Intro Description</label>
        <textarea
          rows={2}
          value={formData.types?.description || ''}
          onChange={(e) => handleTypesChange('description', e.target.value)}
          placeholder="From high-performance native iOS & Android flagships to cross-platform frameworks..."
          style={textareaStyle}
        />
      </div>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F1F5F9', paddingBottom: '12px' }}>
              <span style={{ fontSize: '0.9rem', fontWeight: 800, color: 'var(--dark-indigo, #1a0b54)' }}>
                Type #{idx + 1}: {typeCard.title || 'Untitled App Type'}
              </span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '14px' }}>
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Native iOS & Android Apps"
            ...
            <div>
              ...
              <textarea
                rows={2}
                placeholder="Description of this mobile app type..."
                value={typeCard.desc || ''}
            ...
            <div style={{ backgroundColor: '#F8FAFC', borderRadius: '10px', border: '1px solid #E2E8F0', padding: '14px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div style={{ fontSize: '0.8rem', fontWeight: 700, color: '#334155' }}>
                Showcase Mockups & Performance Badges
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '14px' }}>
                ...
                <ImageFieldWithUpload
                  ...
                  onOpenLibrary={onOpenAssetPicker ? () => onOpenAssetPicker(`mobileApp.types.${idx}.image`) : undefined}
                  uploadPrefix={`mobile-type-${idx + 1}-main`}
                  previewHeight={110}
                ...
                <ImageFieldWithUpload
                  ...
                  recommendedDimensions="400 × 300 px (4:3 Badge)"
                  ...
                  onOpenLibrary={onOpenAssetPicker ? () => onOpenAssetPicker(`mobileApp.types.${idx}.smallImage`) : undefined}
                  uploadPrefix={`mobile-type-${idx + 1}-badge`}
                  previewHeight={110}
                  placeholder="/Home2_files/...webp"
                />
              </div>
