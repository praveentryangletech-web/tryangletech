...
export default function SuperadminSidebar() {
  ...
  const navItems = [
    ...
    {
      label: 'Services CMS',
      tooltip: 'Manage Main Services Overview & Service Type Pages',
      icon: (
        <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      active: pathname.startsWith('/superadmin/services'),
    },
    {
      label: 'Portfolio',
    ...
    {
      label: 'Blog & Articles',
      tooltip: 'Blog CMS, Articles & SEO Metadata',
      icon: (
        <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      active: pathname === '/superadmin/blog' || pathname.startsWith('/superadmin/blog/'),
    },
    {
