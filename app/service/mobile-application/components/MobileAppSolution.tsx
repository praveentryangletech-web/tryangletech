        ...
        >
          ...
          <div className="rt-solution-right-part">
            ...
            <div className="rt-heading-para-gap">
              ...
              >
                Custom architectures for growing digital businesses
              </h2>
            </div>
            <p
              ...
              className="rt-gap-off"
            >
              We build mobile apps that are reliable, scalable, and easy to maintain, ensuring a long lifespan and a high return on investment.
            </p>
              ...
              >
                ...
                <div>
                  ...
                  <p className="rt-gap-off">
                    Connect your mobile app with secure APIs, cloud databases, and third-party services.
                  </p>
                </div>
              </div>
              <div
            ...
            <div className="rt-overflow-hidden">
              ...
              >
                ...
                >
                  <div className="rt-button-text">Start your mobile project</div>
                  <div
